...
public class HtmlTableColumnGroup : HtmlContentElement
{
    protected override string OuterElementName => HtmlElements.ColumnGroup;
    ...
    protected override void OnInitialized()
    {
        ...
        {
            throw new InvalidOperationException($"{nameof(HtmlTableColumnGroup)} must be contained within a {nameof(HtmlTable)}");
        }
    }
}
