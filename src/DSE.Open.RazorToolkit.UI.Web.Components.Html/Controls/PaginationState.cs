...
/// <summary>
/// Holds state to represent pagination in a <see cref="HtmlDataGrid{TGridItem}"/>.
/// </summary>
public class PaginationState
{
    ...
    /// associated <see cref="HtmlDataGrid{TGridItem}"/> assigns a value after loading data.
    /// </summary>
    ...
    /// <summary>
    /// Sets the current page index, and notifies any associated <see cref="HtmlDataGrid{TGridItem}"/>
    ...
    // Can be internal because this only needs to be called by Grid itself, not any custom pagination UI components.
