...
public class HtmlTableFooter: HtmlContentElement
{
    protected override string OuterElementName => HtmlElements.TableFooter;
    ...
    protected override void OnInitialized()
    {
        ...
        {
            throw new InvalidOperationException($"{nameof(HtmlTableFooter)} must be contained within a {nameof(HtmlTable)}");
        }
    }
}
