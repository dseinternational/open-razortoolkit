...
public class HtmlTableCell : HtmlContentElement
{
    protected override string OuterElementName => HtmlElements.TableCell;
    ...
    protected override void OnInitialized()
    {
        ...
        {
            throw new InvalidOperationException($"{nameof(HtmlTableCell)} must be contained within a {nameof(HtmlTableRow)}");
        }
    }
}
